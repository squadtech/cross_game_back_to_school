...
const String AD_MOB_APP_ID = 'ca-app-pub-6432038724997575~3337560962';
const String AD_MOB_AD_ID = 'ca-app-pub-6432038724997575/4075927565';//Interstitial ad id
const String ADD_UNIT_ID ='ca-app-pub-6432038724997575/7085234284';//Ad Unit id
...
class GamePageState extends State<GamePage> {
  ...
  keywords: <String>['games', 'beautiful apps','pubg','communication','social', 'sports','racing'],//categories ads you want to show in your app
